...
Notify("Fedoratum Admin", "Type /console to check customcmds", 4)
...
Notify("Fedoratum Admin", "Anti Kick And Mute Loaded", 4)

task.wait(4)

Notify("Fedoratum Admin", "Type prefix(customcmds) to see custom commands", 4)
